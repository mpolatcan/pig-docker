.PHONY: publish-pig
publish-pig:
	sudo docker build -q -t mpolatcan/pig:ubuntu-0.17.0-hadoop-3.1.1 --build-arg PIG_VERSION="0.17.0" --build-arg HADOOP_VERSION="3.1.1" ./ubuntu/
	sudo docker push mpolatcan/pig:ubuntu-0.17.0-hadoop-3.1.1
	sudo docker rmi mpolatcan/pig:ubuntu-0.17.0-hadoop-3.1.1

	sudo docker build -q -t mpolatcan/pig:alpine-0.17.0-hadoop-3.1.1 --build-arg PIG_VERSION="0.17.0" --build-arg HADOOP_VERSION="3.1.1" ./alpine/
	sudo docker push mpolatcan/pig:alpine-0.17.0-hadoop-3.1.1
	sudo docker rmi mpolatcan/pig:alpine-0.17.0-hadoop-3.1.1
...
# ----------------------------------------------------------------------------------------------------------------------
	...
	sudo docker build -q -t mpolatcan/pig:ubuntu-0.16.0-hadoop-3.1.1 --build-arg PIG_VERSION="0.16.0" --build-arg HADOOP_VERSION="3.1.1" ./ubuntu/
	sudo docker push mpolatcan/pig:ubuntu-0.16.0-hadoop-3.1.1
	sudo docker rmi mpolatcan/pig:ubuntu-0.16.0-hadoop-3.1.1

	sudo docker build -q -t mpolatcan/pig:alpine-0.16.0-hadoop-3.1.1 --build-arg PIG_VERSION="0.16.0" --build-arg HADOOP_VERSION="3.1.1" ./alpine/
	sudo docker push mpolatcan/pig:alpine-0.16.0-hadoop-3.1.1
	sudo docker rmi mpolatcan/pig:alpine-0.16.0-hadoop-3.1.1
